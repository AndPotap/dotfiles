...
autocmd FileType tex inoremap <C-G>a <C-G>u\alpha<Space>
autocmd FileType tex inoremap <C-G>b <C-G>u\beta<Space>
autocmd FileType tex inoremap <C-G>c <C-G>u\psi<Space>
autocmd FileType tex inoremap <C-G>C <C-G>u\Psi<Space>
autocmd FileType tex inoremap <C-G>d <C-G>u\delta<Space>
autocmd FileType tex inoremap <C-G>D <C-G>u\Delta<Space>
autocmd FileType tex inoremap <C-G>e <C-G>u\epsilon<Space>
autocmd FileType tex inoremap <C-G>f <C-G>u\varphi<Space>
autocmd FileType tex inoremap <C-G>F <C-G>u\varPhi<Space>
autocmd FileType tex inoremap <C-G>g <C-G>u\gamma<Space>
autocmd FileType tex inoremap <C-G>G <C-G>u\Gamma<Space>
autocmd FileType tex inoremap <C-G>h <C-G>u\eta<Space>
autocmd FileType tex inoremap <C-G>i <C-G>u\iota<Space>
autocmd FileType tex inoremap <C-G>j <C-G>u\xi<Space>
autocmd FileType tex inoremap <C-G>J <C-G>u\Xi<Space>
autocmd FileType tex inoremap <C-G>k <C-G>u\kappa<Space>
autocmd FileType tex inoremap <C-G>l <C-G>u\lambda<Space>
autocmd FileType tex inoremap <C-G>L <C-G>u\Lambda<Space>
autocmd FileType tex inoremap <C-G>m <C-G>u\mu<Space>
autocmd FileType tex inoremap <C-G>n <C-G>u\nu<Space>
autocmd FileType tex inoremap <C-G>o <C-G>u\omega<Space>
autocmd FileType tex inoremap <C-G>O <C-G>u\Omega<Space>
autocmd FileType tex inoremap <C-G>p <C-G>u\pi<Space>
autocmd FileType tex inoremap <C-G>P <C-G>u\Pi<Space>
autocmd FileType tex inoremap <C-G>q <C-G>u\phi<Space>
autocmd FileType tex inoremap <C-G>Q <C-G>u\Phi<Space>
autocmd FileType tex inoremap <C-G>r <C-G>u\rho<Space>
autocmd FileType tex inoremap <C-G>s <C-G>u\sigma<Space>
autocmd FileType tex inoremap <C-G>S <C-G>u\Sigma<Space>
autocmd FileType tex inoremap <C-G>t <C-G>u\theta<Space>
autocmd FileType tex inoremap <C-G>T <C-G>u\Theta<Space>
" Upsilon is disabled since it affect upper scripts, not sure why
" autocmd FileType tex inoremap <C-G>u <C-G>u\upsilon
" autocmd FileType tex inoremap <C-G>U <C-G>u\Upsilon
autocmd FileType tex inoremap <C-G>w <C-G>u\varsigma<Space>
autocmd FileType tex inoremap <C-G>y <C-G>u\upsilon<Space>
autocmd FileType tex inoremap <C-G>z <C-G>u\zeta<Space>
autocmd FileType tex inoremap <C-G>Z <C-G>u\Zeta<Space>
